...
@section('content')
    <div class="main-content">
        <form action="{{route('founder.update', $update_data->id)}}" method="post" enctype="multipart/form-data">
            @csrf
            {{ method_field('put') }}
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="card-body">
                            <div class="form-group row mb-4">
                                ...
                                <div class="custom-file">
                                    <input type="file" class="custom-file-input" name="teams_upload" id="customFile">
