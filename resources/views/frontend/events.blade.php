    ...
    <main>
                    ...
                    <div class="col-12">
                        <div class="row align-items-center flex-md-row flex-column-reverse gy-4">
                            ...
                            <div class="col-12 col-md-6">
                                <h3>CS FEST</h3>
                                <p>
                                    AIUB CS Fest is one of the biggest and most awaited events organized successfully by
                                    AIUB Computer Club (ACC) every year. The national event promotes with the theme:
                                    ...
                                    AIUB which brings the institutions together with its celebration by students of
                    ...
                    <div class="col-12">
                        <div class="row align-items-center gy-4">
                            ...
                            <div class="col-12 col-md-6">
                                ...
                                <p>
                                    AIUB Cyber Gaming Fest is a national event organized by ACC. The event focuses on
                                    the gamers of various schools and colleges along with the students of AIUB. Students
        ...
        <section class="bg-blue">
            ...
            <div class="programs d-flex align-items-center">
                <img src="https://aiubcc.org/wp-content/uploads/2020/12/82832387_2419429721706243_6661382297708658688_o.jpg"
                     alt="image">
                <div class="overlay"></div>
                <div class="programs-body py-5">
                    ...
                    <p class="text-white">
                        ...
                        January 10 to 12
                        in 2020 at the AIUB campus. AIUB Computer Club supported the event as its volunteers
                        tirelessly
            ...
            <div class="programs d-flex align-items-center">
                ...
                <div class="programs-body py-5">
                    ...
                    <p class="text-white">
                        On February 8, 2020: American International University-Bangladesh (AIUB) hosted the 2020 Cisco
                        ...
                        AIUB Computer Club worked in different sectors of this event.
                    </p>
                </div>
            </div>
